...
| --------------------------------------------------------------------- | ---------------------------------------------------------------- | ------------- |
| **Tidbits** [**- Server**](https://github.com/mat-diak/snacks-server)<br>[**- Client**](https://github.com/mikitaro-27/snacks-client)             | Habit building application, that helps you build healthy habits. | MongoDB, Express, React, Node, Jest, Heroku, Netlify, Bootstrap |
